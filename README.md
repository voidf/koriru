...
所以我们要怎么处理这张图片让我们的程序成功计算出验证码结果呢？

# 1、shadow_split，center_of_gravity

仔细观察可以发现数字的边缘会有一圈灰度并非完全为黑的色块，而杂线和数字字体是完全黑的。这方便我们将传入图片的边缘分割出来（**shadow_split的功能**），并计算这个边缘的重心(**center_of_gravity的功能**)，以便将其平移至画面中心。
